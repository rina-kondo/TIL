...
### EBS最適化オプション
EC2からEBSへのアクセスは、他サーバーとの通信やインターネットとの通信と同じネットワーク帯域を利用してアクセスされます。このため、通信量が多いシステムの場合、EBSへのアクセスに遅延が発生する可能性があります。本オプションを利用することで、以下の機能が実現します。
![[スクリーンショット 2023-07-02 12.20.22.png]]
